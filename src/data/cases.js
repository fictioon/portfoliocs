...
const cases = {
  ecuatraveling: {
    ...
    text: 'Esta página actualmente esta en desarrollo, el cliente corresponde a una agencia de viajes receptiva líder en Ecuador. Tanto el concepto como el diseño de experiencia fue realizado desde cero dando relevancia la parte visual y llamativa de las fotografías, conectado con los turistas que desean visitar Ecuador. Animaciones sencillas y un diseño contemporaneo hace que esta página denote profesionalismo y seguridad para sus clientes.',
    year: '2022',
    roles: ['Diseño', 'ux/ui', 'Front-end'],
    techs: ['Figma', 'NuxtJS', 'Tailwind', 'Directus'],
