...
export default class Preloader extends EventEmitter {
  ...
  createLoadingManager() {
    ...
    const texture1 = new THREE.TextureLoader(this.loadingManager).load('/images/home/cristian-saenz-portrait.jpg')
    const texture2 = new THREE.TextureLoader(this.loadingManager).load('/images/about/cristian-saenz-portrait-lost.jpg')
    const texture3 = new THREE.TextureLoader(this.loadingManager).load('/images/about/cristian-saenz-portrait-hor.jpg')
    ...
    this.loadingManager.onProgress = (url, itemsLoaded, itemsTotal) => {
      ...
      this.preloaderInfoElement.innerHTML = `${Math.round(progressRatio * 8)} años de experiencia`
    }

    this.loadingManager.onLoad = () => {

      // GSAP.delayedCall(0.5, () => {
      //   GSAP.to(this.preloaderElement, { x: '100%', duration: 1, onComplete: this.loaded.bind(this)})
      // })
      this.loaded()
    }
  }
